...
from BioretentionBlues import BCBlues, run_bc_system
import pdb
...
CONFIG = {
    ...
    "flags": {
        ...
        "calcinp": True, #Run the input calcs
        "runall": False, #Run the model without pre-calculating intermediates 
        "runmodel": True, #run the full model
...
results = Parallel(n_jobs=n_jobs, backend="loky")(
    delayed(run_bc_system)(CONFIG, col)
    for col in CONFIG['colnames']
)
